...
st.title('Identifying potential churners through non-time based characteristics')
st.title('* Reactive Action:')
st.title('Providing a prioritized contact list for identifying “best” patients for contact ')
st.text('')
st.text('')
st.text('')
st.text('')
...
image = Image.open('final_slide.png')
